...
int main()
{
   ...
   auto const expected_tokens = std::vector{
      ...
      token{
         token_kind::arrow,
         "->",
         source_coordinate{line_type{2}, column_type{12}},
         source_coordinate{line_type{2}, column_type{14}}
      },
      token{
         token_kind::int32,
         "int32",
         source_coordinate{line_type{2}, column_type{15}},
         source_coordinate{line_type{2}, column_type{20}}
      },
      token{
